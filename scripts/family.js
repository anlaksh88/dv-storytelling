async function init() {
    ...
    var svg = d3.select("#chartArea4").append("svg")
    ...
    var x = d3.scaleLinear()
          .range([0,width])
          .domain([0, d3.max(data, function(d) { return d.Family; })]);
    var y = d3.scaleBand()
    ...
    var div = d3.select("#chartArea4").append("div")	
        .attr("class", "tooltip")				
        .style("opacity", 0);
  ...
  // append the rectangles for the bar chart
    svg.selectAll(".bar")
      ...
      .attr("class", "bar")
      .attr("x", 0 )
      .attr("width", function(d) { return x(d.Family);})
      ...
      .on("mouseover", function(d) {		
            div.transition()		
                .duration(200)		
                .style("opacity", .9);		
            div.html("Country: "+d.Country + "<br/> Family: "  + d.Family + "<br/>Happiness Rank: " + d.Happiness_Rank)	
  ...
  svg.append("g")
	...
	function createAnno(coords){
        ...
        let annoTitle = "Norway does not have highest Family value. But it ranks significantly higher than most countries."
