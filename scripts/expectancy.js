async function init() {
    ...
    var svg = d3.select("#chartArea3").append("svg")
    ...
    var x = d3.scaleLinear()
          .range([0,width])
          .domain([0, d3.max(data, function(d) { return d.Life_Expectancy; })]);
    var y = d3.scaleBand()
    ...
    var div = d3.select("#chartArea3").append("div")	
        .attr("class", "tooltip")				
        .style("opacity", 0);
    ...
    svg.selectAll(".bar")
      ...
      .on("mouseover", function(d) {		
            div.transition()		
                .duration(200)		
                .style("opacity", .9);		
            div.html("Country: "+d.Country + "<br/> Life Expectancy: "  + d.Life_Expectancy+ "<br/>Happiness Rank: " + d.Happiness_Rank)	
  ...
  svg.append("g")
	...
	function createAnno(coords){
        ...
        let annoTitle = "Norway does not have highest life expectancy. But it ranks significantly higher than most countries."
